...
class WorkspaceWidget<T> extends StatelessWidget {
  final T data;
      ...
      child: Column(
        ...
        children: [
              ...
              Positioned(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    chip(
                      Text(
                          workspaceData.pricing?.formattedTotalPerDay ?? "0",
                          style: theme.textTheme.titleLarge?.copyWith(
                            fontSize: 12.spMin,
                            fontWeight: FontWeight.w500,
                          )),
          ...
          Row(
            children: [
              8.horizontalSpace,
              buildRatingStars(theme, workspaceData.ratings?.toDouble() ?? 0),
              6.horizontalSpace,
              Text(
  ...
  Widget chip(Widget text, {double? horizontalPadding, double? verticalMargin}) {
    return Container(
