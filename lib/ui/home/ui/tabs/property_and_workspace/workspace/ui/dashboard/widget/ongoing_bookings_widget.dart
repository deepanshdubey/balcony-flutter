...
class OnGoingBookingsWidget extends StatefulWidget {
  const OnGoingBookingsWidget({Key? key}) : super(key: key);

  @override
  State<OnGoingBookingsWidget> createState() => _OnGoingBookingsWidgetState();
}

class _OnGoingBookingsWidgetState extends State<OnGoingBookingsWidget> {
  final workspaceStore = WorkspaceStore();

  @override
  void initState() {
    super.initState();
    workspaceStore.getOngoingBookings();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Observer(builder: (context) {
      ...
      return Column(
        ...
        children: [
          const SectionTitle(title: "ongoing bookings", subtitle: ""),
          8.h.verticalSpace,
          Container(
                    ...
                    : bookings?.isNotEmpty == true
                        ? ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return OnGoingBookingsRowWidget(
                                booking: workspace,
                                onBookingUpdated: () {
                                  workspaceStore.getOngoingBookings();
                                },
