...
class BookingCalendar extends StatefulWidget {
  final Function(
          String formattedRange, int days, String startDate, String endDate)
      onDateSelected;
...
class _BookingCalendarState extends State<BookingCalendar> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      behavior: HitTestBehavior.opaque, // Ensures gestures are passed through
          ...
          calendarBuilders: CalendarBuilders(
            defaultBuilder: (context, day, focusedDay) {
              if (day.isBefore(DateTime.now())) {
                // Apply a gray text style for past dates
                return Center(
                  child: Text(
                    '${day.day}',
                    style: TextStyle(
                      color: Colors.grey, // Gray color for past dates
