class Constants {
  ...
  static const host = "https://api.hw.co";
  static const baseUrl = "$host/api/v2/";
  static const terms = "$baseHost/terms";
  static const policy = "$baseHost/policy";
  static const leasing = "$baseHost/leasing-policy";
}